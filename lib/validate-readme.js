...
var loadPackageJson = new _bluebird2.default(function (resolve, reject) {
...
var loadReadMe = new _bluebird2.default(function (resolve, reject) {
...
var loadOptions = new _bluebird2.default(function (resolve) {
    resolve({
        tempDir: './.tmp/'
    });
});
...
module.exports = function () {
    _bluebird2.default.all([loadPackageJson, loadReadMe, loadOptions]).then(function (_ref) {
        ...
        return (0, _mochaRunner2.default)(testFileNames).finally(function () {
